...
Provera ispravnosti logovanja vrsi se na osnovu evidencije korisnika.
U glavnom programu, koriscenjem STL kontejnera, evidentirati sledece korisnike:
1. korisnicko_ime: milan, lozinka: 12345
2. korisnicko_ime: marko, lozinka: xyz
3. korisnicko_ime: admin, lozinka: 4dm1n

Nit treba da utvrdi da li je najpre unesena rec "login". Ako jeste, korisnik se moze ulogovati ako postoji
evidentiran korisnik sa unesenim  korisnickim imenom i lozinkom.
